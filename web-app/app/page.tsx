...
export default function Home() {
  const [messages, setMessages] = useState([
    { role: 'assistant', content: "Tell me, what's on your mind?" }
  ]);
        ...
        <div className="max-w-4xl mx-auto flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-right">
              <div className="flex items-center justify-end gap-3 text-[10px] text-red-500 font-bold uppercase tracking-wider drop-shadow-[0_0_5px_rgba(255,0,0,0.8)]">
                <span className="animate-pulse">SYSTEM STATUS: SELF-TRAINED CORE</span>
                <span className="text-red-800">•</span>
                <span>SHARATH’S DIGITAL TWIN</span>
              </div>
